        ...
        <div id="page-container" class="container">
            ...
            <div id="page-content" class="content row">
                <div id="page-left" class="left col-md-4">
                    <div uiType="tree" id="configuration-tree" resource="configuration"></div>
                </div>
                <div id="page-middle" class="middle jumbotron col-md-8">
                    <div uiType="form" id="configuration-form" resource="configuration" dataIdentity="$(system/base_uri)"></div>
                </div>
            </div>
